package net.dcyble.combatsattributes.playerprogress.clientlogic;
...
public class Progress {
    ...
    private static int xpDifference;

    public static void updateXpDif() {
        int[][] levels = {
    ...
    public static int getFreePoints() {
        return freePoints;
    }

    public static int getXpDif() {
        return xpDifference;
    }
}
